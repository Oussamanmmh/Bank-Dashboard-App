export const DebitCard = () => {
    return(
        <>
            <div className="">
                <div className="bg-gray-800 flex h-64 flex-col w-[600px] justify-between  p-4 rounded-xl m-4 bg-gradient-to-r from-blue-500 via-purple-500 to-red-500">
                    <h1 className="text-white text-3xl max-w-1/2">Debit card under new <br/>terms and conditions</h1>
                    <div className="flex items-center pl-3 rounded-lg bg-slate-400 h-10 w-44">
